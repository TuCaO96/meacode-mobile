...
public class StepSixBFragment extends Fragment {
    ...
    public StepSixBFragment() {
        // Required empty public constructor
    }

    public static StepSixBFragment newInstance() {
        return new StepSixBFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_step_six_b, container, false);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((x >= (287 * density) && y >= (701 * density)) && (x <= (459 * density) && y <= (752 * density))){
                    ((IntroActivity)getActivity()).nextStep();
                }
